                        ...
                        <div className="flex flex-col md:flex-row items-center gap-6 mb-6">
                            <div className="relative inline-block">
                                ...
                                <label
                                    ...
                                    className="absolute bottom-0 right-0 bg-slate-600 hover:bg-slate-700 rounded-full p-1.5 cursor-pointer transition-all duration-200 shadow-md hover:shadow-lg border-2 border-white"
                                >
