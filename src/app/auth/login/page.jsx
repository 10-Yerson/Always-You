                        ...
                        <div className="p-8 lg:p-12 bg-white relative overflow-hidden">
                            ...
                            <form onSubmit={handleLogin} className="space-y-6 relative z-10">
                                ...
                                <div className="mb-3 relative z-10 flex">
                                    <Link
                                        href="/"
                                        className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-gray-200 hover:border-blue-400 hover:bg-blue-50 transition-all duration-300 group"
                                    >
                                        <svg className="w-3.5 h-3.5 text-gray-700 group-hover:text-blue-500 group-hover:-translate-x-0.5 transition-all duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 19l-7-7m0 0l7-7m-7 7h18" />
                                        </svg>
                                        <span className="text-sm font-medium text-gray-700 group-hover:text-blue-600 transition-colors duration-300">Volver</span>
                                    </Link>
                                </div>
